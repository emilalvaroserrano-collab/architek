...
import { ArrowUpRight, Loader2, Video, Building2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#EAE9E4] flex flex-col font-sans text-[#222222] overflow-hidden relative">
        ...
        {screen === "welcome" && (
          ...
          >
            {uploaded && uploadedImage ? (
              ...
              <>
                <div className="w-20 h-20 rounded-3xl bg-[#222222] text-white flex items-center justify-center mb-5 shadow-sm">
                  <Building2 className="w-10 h-10 text-white stroke-[1.75]" />
                </div>
                <h1 className="text-[34px] sm:text-[38px] font-syncopate font-bold mb-3 tracking-tight text-center">Architech AI</h1>
                <p className="text-[#222222]/60 mb-6 text-center px-4 text-sm leading-relaxed max-w-sm">
                  Explore how you can visualize and redesign your space in different architectural and interior design styles within seconds
                </p>
              </>
            )}
      ...
      {screen === "cards" && (
        <div className="flex-1 flex flex-col items-center justify-center p-4 relative">
          ...
          <div className="absolute top-6 right-6 z-50 text-[10px] sm:text-xs font-syncopate font-bold tracking-wider text-[#222222]/40 uppercase select-none flex items-center gap-1.5">
            <Building2 className="w-3.5 h-3.5 text-[#222222]/40" />
            <span>Architech AI</span>
          </div>
